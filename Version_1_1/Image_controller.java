...
public class Image_controller {
    ...
    public void Blur() {
        ...
        if(Pixel_list != null) {
            int[][] G_f = new int[][]{{1, 4, 7, 4, 1}, {4, 16, 26, 16, 4}, {7, 26, 41, 26, 7}, {4, 16, 26, 16, 4}, {1, 4, 7, 4, 1}}; //Gaussian filter
                ...
                if (Pixel_list.get(i)[0] != 0 && Pixel_list.get(i)[1] != 0 && Pixel_list.get(i)[0] != last_x && Pixel_list.get(i)[1] != last_y
                    ...
                    */
                    ...
                    for (int k = 2; k < 5; k++) {
                        ...
                        matrix_pixel[0] = Pixel_list.get(pixel_00)[k];
                        matrix_pixel[1] = Pixel_list.get(pixel_01)[k];
                        matrix_pixel[2] = Pixel_list.get(pixel_02)[k];
                        matrix_pixel[3] = Pixel_list.get(pixel_03)[k];
                        matrix_pixel[4] = Pixel_list.get(pixel_04)[k];

                        matrix_pixel[5] = Pixel_list.get(pixel_10)[k];
                        matrix_pixel[6] = Pixel_list.get(pixel_11)[k];
                        matrix_pixel[7] = Pixel_list.get(pixel_12)[k];
                        matrix_pixel[8] = Pixel_list.get(pixel_13)[k];
                        matrix_pixel[9] = Pixel_list.get(pixel_14)[k];

                        matrix_pixel[10] = Pixel_list.get(pixel_20)[k];
                        matrix_pixel[11] = Pixel_list.get(pixel_21)[k];
                        matrix_pixel[12] = Pixel_list.get(i)[k];
                        matrix_pixel[13] = Pixel_list.get(pixel_23)[k];
                        matrix_pixel[14] = Pixel_list.get(pixel_24)[k];

                        matrix_pixel[15] = Pixel_list.get(pixel_30)[k];
                        matrix_pixel[16] = Pixel_list.get(pixel_31)[k];
                        matrix_pixel[17] = Pixel_list.get(pixel_32)[k];
                        matrix_pixel[18] = Pixel_list.get(pixel_33)[k];
                        matrix_pixel[19] = Pixel_list.get(pixel_34)[k];

                        matrix_pixel[20] = Pixel_list.get(pixel_40)[k];
                        matrix_pixel[21] = Pixel_list.get(pixel_41)[k];
                        matrix_pixel[22] = Pixel_list.get(pixel_42)[k];
                        matrix_pixel[23] = Pixel_list.get(pixel_43)[k];
                        matrix_pixel[24] = Pixel_list.get(pixel_44)[k];
                        for (int j = 0; j < 25; j++)
    ...
    public void Bitmap_Gray_scaling() {
        ...
        if (Pixel_list != null) {
            ...
            int size = Pixel_list.size();
            for (int i = 0; i < size; i++) {
                int x = Pixel_list.get(i)[0];
                int y = Pixel_list.get(i)[1];
                int R = Pixel_list.get(i)[2];
                int G = Pixel_list.get(i)[3];
                int B = Pixel_list.get(i)[4];
                int Gray = (R+G+B)/3;
    ...
    public void Bitmap_Change_Mask() {
        ...
        if (Mask_x != null && Mask_y != null && Pixel_gray_list != null) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int G_x = Sum_Mask_x;
                int G_y = Sum_Mask_y;
                int G_value = (Sum_Mask_x > 0 ? Sum_Mask_x : -Sum_Mask_x) + (Sum_Mask_y > 0 ? Sum_Mask_y : -Sum_Mask_y);
    ...
    //
    public Bitmap Image_Bitmap_applying(Bitmap bitmap, Text_Controller txt) {
        ...
        for (int i = 0; i < Pixel_Non_list.size(); i++) {
            int x = Pixel_Non_list.get(i)[0];
            int y = Pixel_Non_list.get(i)[1];
            int color = Pixel_Non_list.get(i)[2];
            newBmp.setPixel(x,y,Color.rgb(color,color,color));
        }
        endTime = System.currentTimeMillis();
        duration= (endTime - startTime);
